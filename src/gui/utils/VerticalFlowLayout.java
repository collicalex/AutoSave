...
public class VerticalFlowLayout implements LayoutManager, Serializable {
	   ...
	   */
	  public VerticalFlowLayout(int halign, int valign, int hgap, int vgap, boolean fullWidth) {
	    _hgap = hgap;
	    _vgap = vgap;
